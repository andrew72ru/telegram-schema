...
/**
 * Returns an HTTPS or a tg: link with the given type. Can be called before authorization @var Expected type of the link @is_http Pass true to create an HTTPS link (only available for some link types); pass false to create a tg: link.
 */
